...
const Todo = () => {
  ...
  const add = () =>{
      ...
      const newTodo = {
        id: Date.now(), //for generating unique id or number
        text: inputText,
        isComplete: false, 
      }
    ...
    flex flex-col p-7 min-h-[550px] rounded-xl'>
     ...
     <div className='flex items-center mt-7 gap-2'>
        ...
        <div className='flex items-center my-7 bg-gray-200 rounded-full'>
          <input ref={inputRef} className='bg-transparent border-0 outline-none flex-1 h-14 pl-6 pr2 placeholder:text-slate-600' type="text"  placeholder='Add Your Task'/>
